...
Infected <- data_15$totale_attualmente_positivi[data_15$totale_attualmente_positivi>0]
Morti=data_15$deceduti
Guariti=data_15$dimessi_guariti

data_15$totale_attualmente_positivi[1]
Day=(max(which(data_15$totale_attualmente_positivi==0))+1):(length(Infected))

N <- 5801692 # population of regione
